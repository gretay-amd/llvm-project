...
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s4, v1
; GFX10-NEXT:    v_readfirstlane_b32 s5, v2
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s5, v2
; GFX10-NEXT:    v_readfirstlane_b32 s6, v3
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s6, v3
; GFX10-NEXT:    v_readfirstlane_b32 s7, v4
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s7, v4
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s4, v1
; GFX11-NEXT:    v_readfirstlane_b32 s5, v2
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s5, v2
; GFX11-NEXT:    v_readfirstlane_b32 s6, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s6, v3
; GFX11-NEXT:    v_readfirstlane_b32 s7, v4
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s7, v4
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1200-NEXT:    v_cmpx_eq_u32_e32 s4, v1
; GFX1200-NEXT:    v_readfirstlane_b32 s5, v2
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    v_cmpx_eq_u32_e32 s5, v2
; GFX1200-NEXT:    v_readfirstlane_b32 s6, v3
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1200-NEXT:    v_cmpx_eq_u32_e32 s6, v3
; GFX1200-NEXT:    v_readfirstlane_b32 s7, v4
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    v_cmpx_eq_u32_e32 s7, v4
; GFX1200-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    v_cmpx_eq_u32_e32 s4, v2
; GFX1250-NEXT:    v_readfirstlane_b32 s5, v3
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_cmpx_eq_u32_e32 s5, v3
; GFX1250-NEXT:    v_readfirstlane_b32 s6, v4
; GFX1250-NEXT:    v_cmpx_eq_u32_e32 s6, v4
; GFX1250-NEXT:    v_readfirstlane_b32 s7, v5
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_cmpx_eq_u32_e32 s7, v5
; GFX1250-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s1, v2
; GFX11-NEXT:    v_readfirstlane_b32 s2, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s2, v3
; GFX11-NEXT:    v_readfirstlane_b32 s3, v4
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s3, v4
...
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1200-NEXT:    v_cmpx_eq_u32_e32 s0, v1
; GFX1200-NEXT:    v_readfirstlane_b32 s1, v2
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    v_cmpx_eq_u32_e32 s1, v2
; GFX1200-NEXT:    v_readfirstlane_b32 s2, v3
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1200-NEXT:    v_cmpx_eq_u32_e32 s2, v3
; GFX1200-NEXT:    v_readfirstlane_b32 s3, v4
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    v_cmpx_eq_u32_e32 s3, v4
...
; GFX1250-NEXT:    v_cmpx_eq_u32_e32 s0, v2
; GFX1250-NEXT:    v_readfirstlane_b32 s1, v3
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_cmpx_eq_u32_e32 s1, v3
; GFX1250-NEXT:    v_readfirstlane_b32 s2, v4
; GFX1250-NEXT:    v_cmpx_eq_u32_e32 s2, v4
; GFX1250-NEXT:    v_readfirstlane_b32 s3, v5
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_cmpx_eq_u32_e32 s3, v5
