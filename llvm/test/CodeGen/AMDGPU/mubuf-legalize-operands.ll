...
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s4, v0
; GFX1010_W32-NEXT:    v_readfirstlane_b32 s5, v1
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s5, v1
; GFX1010_W32-NEXT:    v_readfirstlane_b32 s6, v2
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s6, v2
; GFX1010_W32-NEXT:    v_readfirstlane_b32 s7, v3
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s7, v3
...
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s4, v0
; GFX1010_W64-NEXT:    v_readfirstlane_b32 s5, v1
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s5, v1
; GFX1010_W64-NEXT:    v_readfirstlane_b32 s6, v2
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s6, v2
; GFX1010_W64-NEXT:    v_readfirstlane_b32 s7, v3
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s7, v3
...
; GFX1100_W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100_W32-NEXT:    v_cmpx_eq_u32_e32 s0, v0
; GFX1100_W32-NEXT:    v_readfirstlane_b32 s1, v1
; GFX1100_W32-NEXT:    v_cmpx_eq_u32_e32 s1, v1
; GFX1100_W32-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1100_W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100_W32-NEXT:    v_cmpx_eq_u32_e32 s2, v2
; GFX1100_W32-NEXT:    v_readfirstlane_b32 s3, v3
; GFX1100_W32-NEXT:    v_cmpx_eq_u32_e32 s3, v3
...
; GFX1100_W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100_W64-NEXT:    v_cmpx_eq_u32_e64 s0, v0
; GFX1100_W64-NEXT:    v_readfirstlane_b32 s1, v1
; GFX1100_W64-NEXT:    v_cmpx_eq_u32_e64 s1, v1
; GFX1100_W64-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1100_W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100_W64-NEXT:    v_cmpx_eq_u32_e64 s2, v2
; GFX1100_W64-NEXT:    v_readfirstlane_b32 s3, v3
; GFX1100_W64-NEXT:    v_cmpx_eq_u32_e64 s3, v3
...
; GFX1010_W32-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s4, v4
; GFX1010_W32-NEXT:    v_readfirstlane_b32 s5, v5
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s5, v5
; GFX1010_W32-NEXT:    v_readfirstlane_b32 s6, v6
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s6, v6
; GFX1010_W32-NEXT:    v_readfirstlane_b32 s7, v7
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s7, v7
...
; GFX1010_W64-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s4, v4
; GFX1010_W64-NEXT:    v_readfirstlane_b32 s5, v5
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s5, v5
; GFX1010_W64-NEXT:    v_readfirstlane_b32 s6, v6
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s6, v6
; GFX1010_W64-NEXT:    v_readfirstlane_b32 s7, v7
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s7, v7
...
; GFX1100_W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100_W32-NEXT:    v_cmpx_eq_u32_e32 s0, v4
; GFX1100_W32-NEXT:    v_readfirstlane_b32 s1, v5
; GFX1100_W32-NEXT:    v_cmpx_eq_u32_e32 s1, v5
; GFX1100_W32-NEXT:    v_readfirstlane_b32 s2, v6
; GFX1100_W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100_W32-NEXT:    v_cmpx_eq_u32_e32 s2, v6
; GFX1100_W32-NEXT:    v_readfirstlane_b32 s3, v7
; GFX1100_W32-NEXT:    v_cmpx_eq_u32_e32 s3, v7
...
; GFX1100_W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100_W64-NEXT:    v_cmpx_eq_u32_e64 s0, v4
; GFX1100_W64-NEXT:    v_readfirstlane_b32 s1, v5
; GFX1100_W64-NEXT:    v_cmpx_eq_u32_e64 s1, v5
; GFX1100_W64-NEXT:    v_readfirstlane_b32 s2, v6
; GFX1100_W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100_W64-NEXT:    v_cmpx_eq_u32_e64 s2, v6
; GFX1100_W64-NEXT:    v_readfirstlane_b32 s3, v7
; GFX1100_W64-NEXT:    v_cmpx_eq_u32_e64 s3, v7
...
; GFX1010_W32-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s8, v0
; GFX1010_W32-NEXT:    v_readfirstlane_b32 s9, v1
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s9, v1
; GFX1010_W32-NEXT:    v_readfirstlane_b32 s10, v2
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s10, v2
; GFX1010_W32-NEXT:    v_readfirstlane_b32 s11, v3
; GFX1010_W32-NEXT:    v_cmpx_eq_u32_e32 s11, v3
...
; GFX1010_W64-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s8, v0
; GFX1010_W64-NEXT:    v_readfirstlane_b32 s9, v1
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s9, v1
; GFX1010_W64-NEXT:    v_readfirstlane_b32 s10, v2
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s10, v2
; GFX1010_W64-NEXT:    v_readfirstlane_b32 s11, v3
; GFX1010_W64-NEXT:    v_cmpx_eq_u32_e64 s11, v3
