...
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s4, v7
; GFX10-NEXT:    v_readfirstlane_b32 s5, v6
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s5, v6
...
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_add_f32_e32 v8, v9, v5
; GFX10-NEXT:    s_mov_b32 s9, exec_lo
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    s_mov_b32 s10, s9
...
; GFX10-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s4, v10
; GFX10-NEXT:    v_readfirstlane_b32 s5, v9
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s5, v9
; GFX10-NEXT:    v_readfirstlane_b32 s6, v8
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s6, v8
; GFX10-NEXT:    v_readfirstlane_b32 s7, v7
; GFX10-NEXT:    v_cmpx_eq_u32_e32 s7, v7
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v7
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s0, v7
; GFX11-NEXT:    v_readfirstlane_b32 s1, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s1, v6
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    v_cmpx_eq_u32_e32 s2, v2
; GFX11-NEXT:    v_readfirstlane_b32 s3, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_pk_add_f16 v8, v9, v5
; GFX11-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_mov_b32 s6, s5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_pk_add_f16 v8, v9, v5
; GFX10-NEXT:    s_mov_b32 s9, exec_lo
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    s_mov_b32 s10, s9
; GFX10-NEXT:    v_mov_b32_e32 v0, v8
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s6, s5
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_add_f32 v1, v1, v10 :: v_dual_add_f32 v0, v0, v5
...
; GFX11-FAKE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-FAKE16-NEXT:    s_mov_b32 s6, s5
; GFX11-FAKE16-NEXT:    v_add_f32_e32 v0, v0, v10
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v1, v1, v5 :: v_dual_cndmask_b32 v0, v8, v12
