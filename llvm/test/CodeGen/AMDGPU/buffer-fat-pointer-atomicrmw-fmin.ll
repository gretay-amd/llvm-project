...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_mov_b32 s6, s5
; GFX12-NEXT:    v_pk_min_num_f16 v8, v0, v5
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-NEXT:    s_mov_b32 s6, s5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_pk_min_f16 v8, v0, v5
...
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    s_mov_b32 s10, s9
; GFX10-NEXT:    v_pk_min_f16 v8, v0, v5
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_mov_b32 s6, s5
; GFX12-TRUE16-NEXT:    v_dual_min_num_f32 v1, v1, v10 :: v_dual_min_num_f32 v0, v0, v5
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_mov_b32 s6, s5
; GFX12-FAKE16-NEXT:    v_min_num_f32_e32 v0, v0, v10
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_dual_min_num_f32 v1, v1, v5 :: v_dual_cndmask_b32 v0, v8, v12
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s6, s5
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_min_f32 v1, v1, v10 :: v_dual_min_f32 v0, v0, v5
...
; GFX11-FAKE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-FAKE16-NEXT:    s_mov_b32 s6, s5
; GFX11-FAKE16-NEXT:    v_min_f32_e32 v0, v0, v10
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_min_f32 v1, v1, v5 :: v_dual_cndmask_b32 v0, v8, v12
...
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    s_mov_b32 s10, s9
; GFX10-NEXT:    v_min_f32_e32 v0, v0, v10
