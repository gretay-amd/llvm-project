...
define amdgpu_ps <4 x half> @struct_tbuffer_load_v4f16__vgpr_rsrc__sgpr_vindex__sgpr_voffset__vgpr_soffset(<4 x i32> %rsrc, i32 inreg %vindex, i32 inreg %voffset, i32 %soffset) {
  ...
  ; GFX12-NEXT: {{  $}}
  ; GFX12-NEXT:   [[PHI:%[0-9]+]]:sreg_64_xexec = PHI [[S_MOV_B64_]], %bb.1, %16, %bb.3
  ...
  ; GFX12-NEXT:   V_CMPX_EQ_U64_nosdst_e64 [[COPY11]], [[COPY9]], implicit-def $exec, implicit $exec
  ; GFX12-NEXT:   V_CMPX_EQ_U64_nosdst_e64 [[COPY12]], [[COPY10]], implicit-def $exec, implicit $exec
  ; GFX12-NEXT:   [[V_READFIRSTLANE_B32_4:%[0-9]+]]:sreg_32_xm0 = V_READFIRSTLANE_B32 [[COPY6]], implicit $exec
  ; GFX12-NEXT:   V_CMPX_EQ_U32_nosdst_e64 [[V_READFIRSTLANE_B32_4]], [[COPY6]], implicit-def $exec, implicit $exec
  ; GFX12-NEXT: {{  $}}
  ; GFX12-NEXT: bb.3:
  ...
  ; GFX12-NEXT:   [[S_ANDN2_WREXEC_B64_:%[0-9]+]]:sreg_64_xexec = S_ANDN2_WREXEC_B64 [[PHI]], implicit-def $exec, implicit-def $scc, implicit $exec
