...
define amdgpu_ps float @raw_buffer_atomic_cmpswap_i32__sgpr_val__sgpr_cmp__vgpr_rsrc__sgpr_voffset__vgpr_soffset(i32 inreg %val, i32 inreg %cmp, <4 x i32> %rsrc, i32 inreg %voffset, i32 %soffset) {
  ...
  ; GFX1200-NEXT:   V_CMPX_EQ_U64_nosdst_e32 [[COPY13]], [[COPY11]], implicit-def $exec, implicit $exec
  ; GFX1200-NEXT:   V_CMPX_EQ_U64_nosdst_e32 [[COPY14]], [[COPY12]], implicit-def $exec, implicit $exec
  ; GFX1200-NEXT:   [[V_READFIRSTLANE_B32_4:%[0-9]+]]:sreg_32_xm0 = V_READFIRSTLANE_B32 [[COPY7]], implicit $exec
  ; GFX1200-NEXT:   V_CMPX_EQ_U32_nosdst_e32 [[V_READFIRSTLANE_B32_4]], [[COPY7]], implicit-def $exec, implicit $exec
  ; GFX1200-NEXT: {{  $}}
  ; GFX1200-NEXT: bb.3:
  ...
  ; GFX1250-NEXT:   V_CMPX_EQ_U64_nosdst_e32 [[COPY13]], [[COPY11]], implicit-def $exec, implicit $exec
  ; GFX1250-NEXT:   V_CMPX_EQ_U64_nosdst_e32 [[COPY14]], [[COPY12]], implicit-def $exec, implicit $exec
  ; GFX1250-NEXT:   [[V_READFIRSTLANE_B32_4:%[0-9]+]]:sreg_32_xm0 = V_READFIRSTLANE_B32 [[COPY7]], implicit $exec
  ; GFX1250-NEXT:   V_CMPX_EQ_U32_nosdst_e32 [[V_READFIRSTLANE_B32_4]], [[COPY7]], implicit-def $exec, implicit $exec
  ; GFX1250-NEXT: {{  $}}
  ; GFX1250-NEXT: bb.3:
...
define amdgpu_ps double @raw_buffer_atomic_cmpswap_i64__sgpr_val__sgpr_cmp__vgpr_rsrc__sgpr_voffset__vgpr_soffset(i64 inreg %val, i64 inreg %cmp, <4 x i32> %rsrc, i32 inreg %voffset, i32 %soffset) {
  ...
  ; GFX1200-NEXT:   V_CMPX_EQ_U32_nosdst_e32 [[V_READFIRSTLANE_B32_4]], [[COPY9]], implicit-def $exec, implicit $exec
  ; GFX1200-NEXT: {{  $}}
  ; GFX1200-NEXT: bb.3:
  ; GFX1200-NEXT:   successors: %bb.4(0x40000000), %bb.2(0x40000000)
  ; GFX1200-NEXT: {{  $}}
  ...
  ; GFX1250-NEXT:   V_CMPX_EQ_U32_nosdst_e32 [[V_READFIRSTLANE_B32_4]], [[COPY9]], implicit-def $exec, implicit $exec
  ; GFX1250-NEXT: {{  $}}
  ; GFX1250-NEXT: bb.3:
  ; GFX1250-NEXT:   successors: %bb.4(0x40000000), %bb.2(0x40000000)
  ; GFX1250-NEXT: {{  $}}
