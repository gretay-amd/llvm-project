...
define amdgpu_ps float @struct_buffer_load_f32__vgpr_rsrc__sgpr_vindex__sgpr_voffset__vgpr_soffset(<4 x i32> %rsrc, i32 inreg %vindex, i32 inreg %voffset, i32 %soffset) {
  ...
  ; GFX1200-NEXT:   V_CMPX_EQ_U64_nosdst_e32 [[COPY12]], [[COPY10]], implicit-def $exec, implicit $exec
  ...
  ; GFX1250-NEXT:   V_CMPX_EQ_U64_nosdst_e32 [[COPY12]], [[COPY10]], implicit-def $exec, implicit $exec
