...
define amdgpu_ps float @general_case_load_with_waterfall(ptr %p, i16 %stride, i64 %numVals, i32 %flags) {
  ...
  ; CHECK45-NEXT: {{  $}}
  ; CHECK45-NEXT:   [[PHI:%[0-9]+]]:sreg_32_xm0_xexec = PHI [[S_MOV_B32_5]], %bb.1, %67, %bb.3
  ...
  ; CHECK45-NEXT:   V_CMPX_EQ_U64_nosdst_e32 [[COPY17]], [[COPY15]], implicit-def $exec, implicit $exec
  ; CHECK45-NEXT:   V_CMPX_EQ_U64_nosdst_e32 [[COPY18]], [[COPY16]], implicit-def $exec, implicit $exec
  ; CHECK45-NEXT: {{  $}}
  ; CHECK45-NEXT: bb.3:
  ...
  ; CHECK45-NEXT:   [[S_ANDN2_WREXEC_B32_:%[0-9]+]]:sreg_32_xm0_xexec = S_ANDN2_WREXEC_B32 [[PHI]], implicit-def $exec, implicit-def $scc, implicit $exec
