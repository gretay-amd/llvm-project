...
; SDAG-NEXT:    v_cmpx_eq_u32_e32 s0, v0
; SDAG-NEXT:    v_readfirstlane_b32 s1, v1
; SDAG-NEXT:    v_cmpx_eq_u32_e32 s1, v1
; SDAG-NEXT:    v_readfirstlane_b32 s2, v2
; SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; SDAG-NEXT:    v_cmpx_eq_u32_e32 s2, v2
; SDAG-NEXT:    v_readfirstlane_b32 s3, v3
; SDAG-NEXT:    v_cmpx_eq_u32_e32 s3, v3
; SDAG-NEXT:    v_readfirstlane_b32 s4, v4
; SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; SDAG-NEXT:    v_cmpx_eq_u32_e32 s4, v4
; SDAG-NEXT:    v_readfirstlane_b32 s5, v5
; SDAG-NEXT:    v_cmpx_eq_u32_e32 s5, v5
; SDAG-NEXT:    v_readfirstlane_b32 s6, v6
; SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; SDAG-NEXT:    v_cmpx_eq_u32_e32 s6, v6
; SDAG-NEXT:    v_readfirstlane_b32 s7, v7
; SDAG-NEXT:    v_cmpx_eq_u32_e32 s7, v7
